...
void OLED_Init(void)
{
	...
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;//速度50MHz
 	...
 	GPIO_SetBits(GPIOB,GPIO_Pin_7|GPIO_Pin_6);	//PB6,PB7 输出高
...
{      			    
    ...
    for(t=0;t<csize;t++)
    {   
		if(size==12)temp=asc3_1206[chr][t]; 	 	//调用1206字体
		else if(size==16)temp=asc3_1608[chr][t];	//调用1608字体
		else if(size==24)temp=asc3_2412[chr][t];	//调用2412字体
